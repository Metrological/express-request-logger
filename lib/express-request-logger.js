 ...
 *   An express app.
 * @param redisGetter
 *   Returns a Redis client to use for logging.
 ...
 */
var configure = function(app, redisGetter, options) {
    ...
    var prefix = "rLog:" + options.projectName + ":";
    ...
    app.use(function(req, res, next) {
        ...
        getNextId(function(err, id) {
            ...
            res.once('finish', function() {
                ...
                res.rLog.info.duration = Math.floor(delta * 1000) / 1000;
